...
class VideoProcessor:
    @staticmethod
    def extract_frames(video_path: str, video_id: str, fps_limit: int = 30) -> tuple:
        """
        Extract frames from a video and save to the SSD cache directory using OpenCV.
        Returns (frame_count, effective_fps) tuple.
        """
        ...
        try:
            ...
            # Calculate effective FPS of the extracted frames
